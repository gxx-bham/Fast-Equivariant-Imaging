...
- `light_unet_s1_seed1/` — Light backbone direction smoke: `UNet(scales=3)` + `ArtifactRemoval`, stream E, N_buf=1 seed=1, Fine-tune | ER+MC | ER+EI. Not MoDL. Not formal S1 GO.
