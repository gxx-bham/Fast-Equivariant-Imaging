...
- `stage0b_gate_E/` — Gate E **cross-IP continual**: T1 MRI knee Gaussian 4× → T2 `deepinv.physics.Tomography` (physics-tour **40**-view 64×64; not TomographyWithAstra). Unsupervised MC/EI. No three-arm. `superseded_angles20/` is the 0.3.5-tag 20-view run (not the Gate E readout).
